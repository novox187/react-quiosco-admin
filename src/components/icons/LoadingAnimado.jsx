...
export default function LoadingAnimado({size = 7}) {
  return (
    <svg className={`mr-3 h-${size} w-${size} animate-spin text-white`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
