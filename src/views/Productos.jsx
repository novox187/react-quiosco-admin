...
export default function Productos() {
    ...
    const productosFiltrados = busqueda && productoQuery?.data
    ...
    return (
        <div className='flex flex-col justify-center items-center pr-5 mb-40 pb-20 w-full'>
            ...
            <p className='text-2xl my-5 text-center'>Gestiona, Crea y Edita el contenido de tu Negocio</p>
            ...
            <div className="flex flex-col w-screen md:w-full justify-center items-center md:flex-row md:justify-between pb-5">
                ...
                >
                    ...
                    <Button
                        type="button"
                        isIconOnly
                        className="flex bg-zinc-600 hover:bg-zinc-900 w-10 h-10 items-center justify-center disabled"
                    >
            ...
            <div className={`${productosFiltrados && productosFiltrados.length > 0 ? 'grid gap-2 grid-cols-1 justify-center items-center sm:grid-cols-2 max-w-56 sm:max-w-96 md:max-w-none md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4' : 'h-96 flex items-center justify-center'}`}>
                {productosFiltrados && productosFiltrados.length > 0 ? (
                    ...
                    <p className='flex flex-col items-center justify-center w-full text-center text-slate-400'>No hay resultados para esta búsqueda
